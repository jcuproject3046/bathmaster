	...
	,initComponent: function(){
		Ext.apply(this,{
			...
			,bbar: new Ext.StatusBar({
	            id: 'basic-statusbar'
		        ,items: ['<font color="#008CD2">空闲淋位</font>', '-'
		        	, '<font color="#FF7D00">预定淋位</font>', '-'
		        	,'<font color="#FFE000">已使用淋位</font>', '-'
		        	,'<font color="#E40090">结账淋位</font>', '-'
		        	,'<font color="#00AF4D">清洁淋位</font>', '-'
		        	,'<font color="#E80033">锁淋位</font>', '-'
